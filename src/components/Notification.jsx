...
import { notificationMessages } from "../data/dummy";
...
const Notification = () => {
  ...
  return (
    <div className="bg-white dark:bg-secondary-dark-bg  dark:text-white p-6 shadow-md rounded-xl h-auto w-96 absolute top-14 right-40 z-50">
