...
const Ecommerce = () => {
  ...
  return (
    <div className="p-8 md:m-0 mt-10">
      ...
      {/* Cards */}
      <div className="w-full h-96 lg:w-1/2 grid grid-cols-2 gap-4 my-4">
      ...
      {/* Revenue Updates */}
      <div className="bg-white w-full h-96 lg:w-1/2 dark:text-gray-200 dark:bg-secondary-dark-bg p-8 rounded-2xl shadow-md">
        {/* Revenue */}
